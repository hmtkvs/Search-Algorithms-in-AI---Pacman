...
# A routine process for the methods: DFS , BFS , 
def graphSearch(problem, closed, fringe):
    """
    ...
    # Push the first 1 from the specified fringe( Stack, Queue, Priority Queue/ .... )
    fringe.push(start)
...
def depthFirstSearch(problem):
    ...
    "*** MY CODE HERE ***"
    # Stack Settings
    return graphSearch(problem, closed=set(), fringe=util.Stack())
...
def breadthFirstSearch(problem):
    ...
    "*** MY CODE HERE ***"
    # Queue Settings
    return graphSearch(problem, closed=set(), fringe=util.Queue())
...
def uniformCostSearch(problem):
    ...
    return graphSearch(problem, closed=set(), fringe=util.PriorityQueueWithFunction(fn))
